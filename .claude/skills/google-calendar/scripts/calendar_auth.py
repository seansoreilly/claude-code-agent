#!/usr/bin/env python3
"""One-time Google Calendar OAuth setup (headless OOB flow)."""
import sys
import json
import argparse
...
TOKEN_PATH = Path("/home/ubuntu/.claude-agent/google-token.json")
...
def cmd_get_url():
    ...
    # OOB flow: Google shows the code on-screen after user authorizes
